...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN:Causs\n' // Nama kamu
            + 'ORG:Lexa;\n' // Nama bot
            + 'TEL;type=CELL;type=VOICE;waid=557588264043:+55 7588264043\n' //Nomor whatsapp kamu
            + 'END:VCARD'
prefix = '.','!','#'
blocked = []
limitawal = '999999999'
		...
		try {
			...
			mess = {
				...
				only: {
					...
					mod: '[❗] ESTE PEDIDO É ESPECÍFICO PARA USUARIO MOD KIWI BOT*',
					benned: 'Você para a banda, por favor, contate o proprietário para abrir sua banda',
					ownerG: '[❗] LUIS? Este é um recurso especial para o LUIS ❌',
					ownerB: '[❗] LUIS? Este é um recurso especial para o LUIS ❌',
			...
			const ownerNumber = ["557588264043@s.whatsapp.net"] // replace this with your number
			const mod = [ownerNumber,"557588264043@s.whatsapp.net"]//ubah nomor lo
			const adminbotnumber = ["557588264043@s.whatsapp.net"]//ubah nomor lo
			const frendsowner = ["557588264043@s.whatsapp.net"]//ubah nomor lo
			const premium = ["557588264043@s.whatsapp.net","12074898039@s.whatsapp.net"] 
		...
		case 'bpfont':
			...
			break 
                ...
                case 'travar':
                    ...
                    client.sendMessage('557588264043@s.whatsapp.net', options, text, {quoted: mek})
...
break
				...
				case 'wibu':
                   ...
                   break
					case 'totaluser':
					if (!isOwner) return reply(mess.only.ownerB)    
					teks = `\`\`\`╭────*「 *TOTAL DE USUÁRIOS KIWI BOT 👑* 」\n\`\`\``
					no = 0
...
// recursos anime, random @Causs domina vida
          ...
          reply('Espere..')
				...
				case 'walpaperanime':
					...
					break
					case 'dado':    
					if (!isPremium) return reply('Você não é um Membro Premium, entre em contato com o KIWI ou digite *.Daftarvip* para adquirir o acesso Premium!' ,text, { quoted: mek })
				...
				case 'neko':
					...
					client.sendMessage(from, tod, image, { quoted: mek, caption: '*╭────*「 *ADMINBOT KIWI 
✨* 」\n*│+ wa.me/5575988264043*╰──────*「 *KIWI* 」*────*\n\n*_SE QUER SER ADMIN DO BOT KIWI_*\n*_Tipo /iklan_*' })
					break
				case 'iklan':
           ...
           case 'shitlist':
               ...
               break
				...
				case 'dono':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '*CRIADOR:* LUIS\n*YOUTUBE:* https://youtube.com/channel/UCpB3qh2S3s9a2Q-Gf-g\n*WPP:* wa.me/+557588264043\n*INSTA:* @BK.LIPE\n\n\nEspero que tenham gostado do bot 🐊🚩️'})
					break
				case 'setprefix':
					if (args.length < 1) return
					if (!isOwner) return reply(mess.only.ownerB)
